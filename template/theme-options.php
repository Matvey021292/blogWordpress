    ...
    $custom_settings = array(
        ...
        'settings' => array(
            ...
            array(
                ...
                'id' => 'about_logo_upload',
                'label' => 'Логотип',
                'desc' => 'Загрузить картинку  банера',
                'type' => 'upload',
                'section' => 'about',
            ),array(
                'id' => 'about_text_head',
            ...
            array(
                'id' => 'logo_upload',
                'label' => 'Логотип',
                'desc' => 'Загрузить картинку верхнего банера',
                'type' => 'upload',
                'section' => 'header',
            ),
            array(
            ...
            array(
                'id' => 'logo_upload_sale',
                'label' => 'Логотип sale',
                'desc' => 'Загрузить картинку sale банера',
                'type' => 'upload',
                'section' => 'header',
            ),
            array(
            ...
            array(
                'id' => 'header_feedback_form',
                'label' => "Форма обратной связи",
                'desc' => 'Добавте в  поле шорткод из плагина Contact Form 7',
                'std' => '',
                'type' => 'text',
                'section' => 'header',
                'condition' => 'header_feedback_on_off:is(on)',
